...
def find_column(input_text, token):
    """Calcula la columna de un token en el texto de entrada"""
...
def p_error(p):
    if p:
        ...
        print(f"  Tip: Verifica que IF tenga ENDIF, DO tenga ENDDO, y paréntesis estén balanceados")
    else:
        print("Error sintáctico: el archivo terminó inesperadamente")
        print("  Tip: ¿Olvidaste cerrar un bloque IF o DO?")
